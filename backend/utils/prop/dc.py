...
class DocumentProcessor:
    ...
    async def process_file(file: UploadFile) -> str:
        ...
        try:
            ...
            if ext in ['pdf']:
                ...
                return DocumentProcessor._process_hwp(content)
            elif ext == 'docx':
                return DocumentProcessor._process_docx(content)
            elif ext == 'doc':
                return DocumentProcessor._process_doc(content)
    ...
    @staticmethod
    def _process_hwp(content: bytes) -> str:
        """HWP/HWPX 파일 처리"""
    ...
    @staticmethod
    def _process_excel(content: bytes) -> str:
        """Excel 파일 처리"""
