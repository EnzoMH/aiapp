...
* 🔍 **Bid Announcement Crawling**: Government procurement information crawling (G2B)
* 🔍 **입찰공고 크롤링**: 나라장터(G2B) 입찰공고 정보 크롤링
...
<table>
  ...
  <tr>
    <td><b>Web Crawling / 웹 크롤링</b></td>
    <td>Selenium, WebDriver, BeautifulSoup4</td>
  </tr>
</table>
...
│
├── test/                       # 테스트 및 데이터 디렉토리
│   └── all_crawling_results_*.json # 크롤링 결과 파일
│
├── .env                        # 환경 변수 설정
